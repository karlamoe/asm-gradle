...
public final class MultiMethodVisitor extends MethodVisitor {
    public static final Function<Collection<MethodVisitor>, MethodVisitor> CREATOR = MultiMethodVisitor::new;

    private final Collection<MethodVisitor> mvs;

    public MultiMethodVisitor(Collection<MethodVisitor> mvs) {
        super(Opcodes.ASM9);
        this.mvs = mvs;
    }
    ...
    public AnnotationVisitor visitAnnotationDefault() {
        return MultiCreator.createMulti(mvs,
    ...
    public AnnotationVisitor visitParameterAnnotation(int parameter, String descriptor, boolean visible) {
        return MultiCreator.createMulti(mvs,
                it -> it.visitParameterAnnotation(parameter, descriptor, visible),
                MultiAnnotationVisitor.CREATOR
        );
    }
